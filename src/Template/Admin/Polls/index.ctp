...
<div class="right_col" role="main" ng-init="
        doGet('/admin/polls/index?from=<?=$from?>&to=<?=$to?>', 'list', 'polls');
    ">
    <div class="">
                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                <thead>
                                    <tr class="headings">
                                        ...
                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'id'])?>
                                            <?=__('id')?> </th>

                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'poll_title', 'search'=>'poll_title'])?>
                                            <?=__('poll_title')?> </th>

                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'language_id', 'filter'=>$this->Do->get('langs')])?> 
                                            <?=__('language_id')?> </th>

                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'stat_views'])?> 
                                            <?=__('stat_views')?> </th>

                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'stat_shares'])?> 
                                            <?=__('stat_shares')?> </th>

                                        <th class="column-title">
                                            <?=$this->element('colActions', ['url'=>'polls/index', 'col'=>'rec_state', 'filter'=>$this->Do->get('bool')])?> 
                                            <?=__('status')?> </th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="pointer" ng-repeat="itm in list.polls">
                                        ...
                                        <td class=" last">
                                            <a href="<?=$app_folder?>/admin/polls/view/{{itm.id}}"><i class="fa fa-eye"></i> <?=__('view')?></a>
                                            <a href="<?=$app_folder?>/admin/polls/edit/{{itm.id}}"><i class="fa fa-pencil"></i> <?=__('edit')?></a>
                                        </td>
                                    </tr>
