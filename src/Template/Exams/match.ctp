                        ...
                        <div class="col-12 col-md-6">
                            <div class="row ">
                                <div class="col-12 col-md-12">
                                    ...
                                    <div class="row mt-5 mb-5">
                                        <div class="col-12 col-md-12" ng-if="cmptId<0 && isInv<0">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div><?=$poll->poll_text?></div>
                                                <?php if($poll->poll_type != 4){
                                                        foreach($poll->options as $option){?>
                                                    <span class="badge badge-info"><?=$option->option_text?></span>
                                                    <?php }
                                                    }?>
                                            </div>
                                            <hr>
                                    ...
                                    <!-- User info -->
                                    <form class="row" 
                                          action="<?=$path.'/'.$currlang?>/match/<?=$exam->slug?>?p=0" method="POST">
...
<?=$this->Form->control("matchid", ["type"=>"hidden", "value"=>$this->request->getQuery('matchid')]);?>
                                        ...
                                        <div class="col-12 mt-3 text-center">
                                            <button class="btn btn-secondary swipe-to-top"
                                                ...
                                                <i class="fas fa-graduation-cap"></i> <?=__('start_the_game')?>
                                            </button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <?php }else{ ?>
                                        <div class="funkyradio col-<?=@$poll->poll_configs['isBigPhoto'] == '1' ? '12 bigPhoto' : '12'?>">
