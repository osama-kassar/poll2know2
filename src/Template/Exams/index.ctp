<?=$this->element('whereIm')?>
    ...
    <div id="header_exams_slot" class="adArea" style="max-width: 600px; margin: auto;"></div>
...
<section class="pro-content shop-content shop-special">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    foreach($exams as $k=>$itm){
                                        $ad_place++;
                                        if($ad_place==3){
                                            echo '<div id="listItem_exams_'.ceil($k/3) .'_slot" class="adArea"></div>';
                                            $ad_place=0;
                                        }
                                ?>
    ...
    <div id="footer_exams_slot" class="adArea"></div>

<?php /* Ad Maven Pop?>
<script data-cfasync="false" src="//d24g87zbxr4yiz.cloudfront.net/?xbzgd=946866"></script>
<?php */?>