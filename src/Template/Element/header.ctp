                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-2">
                    <ul class="pro-header-right-options">
                        ...
                        <li class="dropdown" data-toggle="tooltip" data-placement="top" title="<?= __('scores') ?>">
                            <button class="btn dropdown-toggle" type="button" id="headerOneCartButton" data-toggle="dropdown" ng-click="callAction('/configs/getscores', 'latestScores', 'GET', '', 'star')">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-4 pl-0">
                    <div class="cart-dropdown dropdown">
                        <a class="cart-dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ng-click="callAction('/configs/getscores', 'latestScores', 'GET', '', 'star')">
