           ...
           var clear = $('<span/>',{
            ...
            $styledSelect.click(function (e) {
                ...
                $('div.styledSelect.active').each(function () {
                    $(this).removeClass('active').next('ul.options-easySelect').hide();
                });
                $(this).toggleClass('active').next('ul.options-easySelect').toggle();
            });
...
/*--================================*/
            ...
            $input.keyup(function () {
                var val = $(this).val();
                var isMatch = false;
                $listItems.find('.container-easySelect').each(function (i) {
