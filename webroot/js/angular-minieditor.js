...
//        [, 'createlink', 'insertimage']
    ...
    angular.module('minieditor', []).directive('minieditor', ['$compile', '$timeout', 'minieditorUI', function ($compile, $timeout, minieditorUI) {
        function link($scope, $element, $attrs, $ctrl) {
            ...
            function refreshState() {
                ...
                angular.forEach(miniCommands, function (commandObj, command) {
                    ...
                    if (command == 'dirleft' || command == 'dirright') {
                        var selection = window.getSelection().getRangeAt(0);
                        console.log("selection", selection)
//                        if(selection.startContainer.nodeName = '#text'){
                            selection = '<div dir="ltr">'+selection+'</div>'
//                        }
