            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="registration-process">
                    <form method="post" novalidate="novalidate" ng-submit="doLogin();" id="login_form">
                        ...
                        <div class="from-group" style='padding-buttom:10px'>

                            <button class="btn btn-main text-light swipe-to-top" id="login_btn">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="registration-process">
                    ...
                    <div class="from-group">
                        <div class="btn btn-dark btn-main swipe-to-top" data-toggle="modal" data-target="#register_mdl"
                            data-dismiss="modal">
